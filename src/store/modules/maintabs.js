...
const actions = {
  addTab({state,commit},route){
    getMenuTreeByUsername().then(res => {
      // res.data[1].children.push(JSON.parse('{"createBy":null,"createTime":null,"updateBy":null,"updateTime":null,"id":4,"menuPid":2,"menuPids":"[0],[1],[12]","menuName":"角色管理","menuSort":2,"isLeaf":true,"url":"/home/sysmaterial","icon":"el-icon-fa fa-users","level":3,"status":false,"hidden":false,"viewImport":"system/SystemMaterial.vue","children":[],"path":"/home/sysmaterial","name":"语料管理","parentId":12}'))
