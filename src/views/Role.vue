    ...
    <el-dialog title="编辑信息" v-model="dialogFormVisible"
      ...
      <el-form :model="dialogForm" ref="dialogForm"
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="排序序号" prop="roleSort">
              <el-input-number v-model="dialogForm.roleSort" :min="1"  label="排序序号"></el-input-number>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
import {getRoles,updateRole,addRole,deleteRole,changeRoleStatus} from "../api/index";
import {getMenuCheckedTree,saveMenuCheckedKeys} from "../api/index";
import {getApiCheckedTree,saveApiCheckedKeys} from "../api/index";
...
export default {
  ...
  data() {
    return {
      ...
      handlingRoleCode: null, //当前正为哪一个角色分配权限：roleCode
