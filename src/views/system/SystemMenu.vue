  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="tableData" row-key="id"
        ...
        <el-table-column prop="menuName" label="菜单名称" width="200" fixed="left"/>
        <el-table-column prop="url" label="前端路由" width="150" align="center"/>
        <el-table-column prop="status" label="是否禁用" width="150" align="center">
        ...
        <el-table-column prop="hidden" label="是否隐藏" width="150" align="center">
          <template slot-scope="scope">
            <el-switch
              active-text ="是"
              inactive-text = "否"
              v-model="scope.row.hidden"
              @change=changeHidden(scope.$index,scope.row) >
            </el-switch>
          </template>
        </el-table-column>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible"
      ...
      <el-form :model="dialogForm" ref="dialogForm"
               :rules="dialogFormRules" label-width="150px">
        <el-row :gutter="20">
          <el-col :span="24">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="排序序号" prop="menuSort">
              <el-input-number v-model="dialogForm.menuSort" :min="1"  label="排序序号"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="24">
            <el-form-item label="前端组件import路径" prop="viewImport">
              <el-input v-model="dialogForm.viewImport" autocomplete="off"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
  import {getMenuTree,updateMenu,addMenu,deleteMenu,changeMenuStatus,changeMenuHidden}
    ...
    methods: {
      ...
      setData(menuTree) {
        if (menuTree.code === 0) {
          ...
          this.tableData = menuTree.data[0].children
        }
      }
    },
