  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="tableData" row-key="id"
        ...
        <el-table-column prop="orgSort" label="排序" width="200" align="center"/>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible"
      ...
      <el-form :model="dialogForm" ref="dialogForm"
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="排序序号" prop="orgSort">
              <el-input-number v-model="dialogForm.orgSort" :min="1"  label="描述文字"></el-input-number>
            </el-form-item>
          </el-col>
...
<script>
  ...
  export default {
    ...
    beforeRouteEnter(to, from, next) {
      getOrgTree({name: null, status: null})
      .then(res => {
