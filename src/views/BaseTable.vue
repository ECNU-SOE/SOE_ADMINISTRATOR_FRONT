    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 数据展示
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
    ...
    setup() {
        ...
        const getData = () => {
            fetchData(query).then((res) => {
              ...
              tableData.value = [{name:"用户1",sex:"男",nation:"汉",language:"中文",username:"trz",password:"123",permission:"admin"},{name:"用户2",sex:"男",nation:"汉",language:"中文",username:"trz",password:"123",permission:"admin"}];
              pageTotal.value = 2;
            });
        };
        getData();
